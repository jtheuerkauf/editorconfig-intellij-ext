...
of the settings they provide, so the list is manually obtained and maintained by opening a
JetBrains IDE and looking for new entries that aren't already listed.

## Now

I'll attempt to provide a description for each item (or groups, when a setting repeats across
supported languages).
